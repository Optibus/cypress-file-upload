...
const ENCODING_TO_BLOB_GETTER = {
  ...
  [ENCODING.BASE64]: (fileContent, mimeType) => Cypress.Promise.try(() => Cypress.Blob.base64StringToBlob(fileContent, mimeType)),
  [ENCODING.BINARY]: (fileContent, mimeType) => Cypress.Promise.try(() => Cypress.Blob.binaryStringToBlob(fileContent, mimeType)),
